...
- **URL:** `https://github.com/Jayconius/Pi-Hole-Gaming-Lists/blob/main/Gaming%20Ads%20Blocklist.txt`

### 2. Gaming Whitelist
This list contains essential domains that should be **allowed** to ensure achievements and cloud saves work.
- **URL:** `https://github.com/Jayconius/Pi-Hole-Gaming-Lists/blob/main/Gaming%20Whitelist.txt`
